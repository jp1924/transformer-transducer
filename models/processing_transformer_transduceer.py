...
"""
Speech processor class for TransformerTransducer
"""
...
class TransformerTransducerProcessor(ProcessorMixin):
    r"""
    Constructs a TransformerTransducer processor which wraps a TransformerTransducer feature extractor and a TransformerTransducer CTC tokenizer into a single
    processor.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        try:
            ...
            warnings.warn(
                ...
                "removed in v5. Please add `'tokenizer_class': 'TransformerTransducerCTCTokenizer'`"
